/* $Id: xuartlite_l.h,v 1.1.2.1 2008/02/12 12:42:02 svemula Exp $ */
/*****************************************************************************
*
...
#define XUartLite_In32  XIo_In32
#define XUartLite_Out32 XIo_Out32
...
*		void XUartLite_mWriteReg(u32 BaseAddress, u32 RegOffset,
*					u32 Data)
*
****************************************************************************/
...
*
* @note		C-style signature:
*		u32 XUartLite_mReadReg(u32 BaseAddress, u32 RegOffset)
*
****************************************************************************/
...
#define XUartLite_mSetControlReg(BaseAddress, Mask) \
	XUartLite_mWriteReg((BaseAddress), XUL_CONTROL_REG_OFFSET, (Mask))
...
#define XUartLite_mGetStatusReg(BaseAddress) \
		XUartLite_mReadReg((BaseAddress), XUL_STATUS_REG_OFFSET)
